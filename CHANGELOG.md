...
> This file is upstream's release history, generated by release-please from the
> conventional commits on `hugo-andrade/avellcc`. The work in this fork — Storm
> 470 support and the Omarchy integration — is **not** in it and never will be:
> the fork does not cut releases. What changed here is in
> [`docs/fork-changes.md`](docs/fork-changes.md), and `avellcc -v` reports the
> module version stamped into the binary (tag, commit and a `+dirty` marker),
> which is what identifies a fork build.
...
* add Makefile, linter, GitHub Actions workflows, and issue templates ([53e09be](https://github.com/hugo-andrade/avellcc/commit/53e09bea3ca6665737a311b2ac83d2b929e143d8))
* bump GitHub Actions to latest versions ([660cea4](https://github.com/hugo-andrade/avellcc/commit/660cea4a95e856645b046a8166dd710952ba8a59))
